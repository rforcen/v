...
#define null NULL
 ...
 public:
  ...
  // hePool, stores all new HalfEdge in a unique map
  static map<HalfEdge*, int>hePool;
  static void addHe(HalfEdge*he);
  static void addHe(HalfEdge*he0, HalfEdge*he1, HalfEdge*he2);
  static void delAllHe();
