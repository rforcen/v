...
void HalfEdge::setNext(HalfEdge* edge) { next = edge; }
...
void HalfEdge::setPrev(HalfEdge* edge) { prev = edge; }
 ...
 */
Face* HalfEdge::getFace() { return face; }
 ...
 */
HalfEdge* HalfEdge::getOpposite() { return opposite; }
 ...
 * @return head vertex
 */
Vertex* HalfEdge::head() { return vertex; }
 ...
 * @return tail vertex
 */
Vertex* HalfEdge::tail() { return prev != null ? prev->vertex : null; }
...
string HalfEdge::getVertexString() {
  if (tail() != null) {
    return "" + std::to_string(tail()->index) + "-" +
