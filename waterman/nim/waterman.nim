...
when isMainModule:
    ...
    proc draw() =
        ...
        proc title = glutSetWindowTitle(fmt("Waterman {radius.int}, faces:{faces.len}, vertices:{vertices.len}").cstring)
        #[
        ...
        discard glutCreateWindow(fmt("Waterman {radius.int} faces:{faces.len}, vertices:{vertices.len}").cstring)
